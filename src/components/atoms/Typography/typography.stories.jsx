...
const Template = (args) => <ThemeProvider theme={args.theme === 'patient' ? patientTypography : providerTypography}><MUITypography variant={args.variant}>{args.content}</MUITypography></ThemeProvider>;
